...
(function () {
    ...
    var game = new Phaser.Game(1000, 750, Phaser.AUTO, 'game');

    game.state.add('Boot', Turtles.Boot);
    game.state.add('Preloader', Turtles.Preloader);
    game.state.add('MainMenu', Turtles.MainMenu);
    game.state.add('Game', Turtles.Game);
